<template>
    <nb-container>
        <Spinner
          :visible="isLoading"
        />
        <header-with-nav :navigation="navigation" headerName="Partner Payouts" :style="{elevation:2}"/>
        <nb-content padder>
            <nb-view class="total-section">
                <nb-view class="total-section-left">
                    ...
                    <nb-view class="total-value">
                        <image class="total-value-image" :source="require('../../../assets/images/icons/income.png')"/>
                ...
                <nb-view class="total-section-left">
                    ...
                    <nb-view class="total-value">
                        <image class="total-value-image" :source="require('../../../assets/images/icons/payout.png')" :style="{tintColor:'#fcbe00'}"/>
            ...
            <nb-view v-if="payouts.length!=0">
                <nb-view class="payout-item" v-for="payout in payouts" :key="payout.id">

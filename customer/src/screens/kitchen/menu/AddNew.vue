<template>
    <nb-container>
        <Spinner
            :visible="isLoading"
        />
        <header :navigation="navigation" headerTitle="New Dish" />
        <nb-content padder>   
            ...
            <nb-view class="food-type">
                <nb-view class="food-type-item" :style="{marginRight:30}">
            ...
            <touchable-opacity regular :class="!form.selectedItems.length && form.dishName ? 'input-item-touchable-error':'input-item-touchable'" :on-press="()=>{ $refs.category.open()}">
        ...
        <nb-view class="footer">
            ...
            <touchable-opacity class="save-button" :on-press="()=>addNewDish()">
...
export default {
    ...
    methods: {
        ...
        selectCategory(categoryId,categoryName){
            ...
            console.log(this.form.selectedCategories)
            console.log(this.form.selectedItems)
        },
        cancelCategories(){

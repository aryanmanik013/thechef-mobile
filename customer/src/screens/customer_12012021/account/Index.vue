        ...
        <nb-content padder>
            ...
            <nb-list>
                ...
                <nb-list-item icon noBorder class="profile-menu-item">
                    <nb-left>
                        <nb-view class="menu-icon-background">
                            <image :source="require('../../../../assets/images/icons/credit_card.png')" class="menu-icon" />
                        </nb-view>
                    </nb-left>
                    <nb-body>
                        <nb-text class="menu-title" :on-press="()=>{navigation.navigate('Information',{slug:1})}">Payment</nb-text>
                    </nb-body>
                </nb-list-item>
            </nb-list>

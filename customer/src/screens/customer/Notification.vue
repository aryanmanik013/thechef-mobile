...
export default {
    ...
    methods: {
        ...
        navigateNotification(notification){
            // console.log(notification.parameter)
            if(notification.route=='Information'){
                this.navigation.navigate(notification.route, {slug: notification.parameter})
            } else if(notification.route=='KitchenDetail'){
                this.navigation.navigate(notification.route, {kitchenId: notification.parameter})
            } else if(notification.route=='OrderDetail'){
